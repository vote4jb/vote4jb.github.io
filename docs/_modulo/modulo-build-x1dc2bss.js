...
window.moduloBuild.modules["xx7gocbi"] = function library_NavBar_script (modulo) {
...
window.moduloBuild.nameToHash.library_NavBar_script = "xx7gocbi";

window.moduloBuild.modules["xx7gocbi"] = function library_MobileNavBar_script (modulo) {
var script = { exports: {} }; var props, state, script, element;
function prepareCallback() {
    // On mobile, have it start as hidden if not index.html, otherwise start as
    // expanded (hide=false)
...
window.moduloBuild.nameToHash.library_MobileNavBar_script = "xx7gocbi";
...
window.moduloBuild.modules["xxrm20o6"] = function library_HeroInset_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.nameToHash.library_HeroInset_template = "xxrm20o6";
...
library_HeroInset_template: {"Parent":"library_HeroInset","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"library_HeroInset_template","Source":"http://127.0.0.1:6627/static/libraries/layout/HeroInset.html","Hash":"Txxrm20o6"}, 
