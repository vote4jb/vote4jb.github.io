...
window.moduloBuild.modules["x1cudikf"] = function library_NavBar_script (modulo) {
...
window.moduloBuild.nameToHash.library_NavBar_script = "x1cudikf";

window.moduloBuild.modules["x1cudikf"] = function library_MobileNavBar_script (modulo) {
var script = { exports: {} }; var props, state, script, element;
const volunteerNav = [
        {
            href: '/contact/?volunteer=y',
...
window.moduloBuild.nameToHash.library_MobileNavBar_script = "x1cudikf";

window.moduloBuild.modules["x15ga87e"] = function library_Banner_script (modulo) {
var script = { exports: {} }; var props, ebState;
        ...
        function prepareCallback() {
            ...
            if (props.expiry) {
                ...
                if (expired === false) {
                    console.log('not expired!', JSON.stringify(ebState));
...
window.moduloBuild.nameToHash.library_Banner_script = "x15ga87e";
...
window.moduloBuild.modules["x1nt1e3v"] = function library_NavBar_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.nameToHash.library_NavBar_template = "x1nt1e3v";
...
library_NavBar_template: {"Parent":"library_NavBar","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"library_NavBar_template","Source":"http://127.0.0.1:6627/static/libraries/layout/NavBar.html","Hash":"Tx1nt1e3v"}, 
