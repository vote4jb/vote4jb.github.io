...
window.moduloBuild.modules["x1t14n32"] = function library_MobileNavBar_template (modulo) {
return function (CTX, G) { var OUT=[];
  ...
  OUT.push(", 1fr)\">\n        "); // ", 1fr)\">"
  var ARR0=CTX.script.volunteerNav;for (var KEY in ARR0) {CTX. page=ARR0[KEY]; // "for page in script.volunteerNav"
  OUT.push("\n            <li>\n                <a href=\""); // "<li><a href=\""
...
window.moduloBuild.modules["xxikgp9a"] = function library_NavBar_template (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.modules["xxihue96"] = function library_Page_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("<head>\n    <title>"); // "<head><title>"
...
window.moduloBuild.nameToHash = {
 ...
 "library_Page_template": "xxihue96",
 "library_NavBar_template": "xxikgp9a",
 "library_MobileNavBar_template": "x1t14n32",
