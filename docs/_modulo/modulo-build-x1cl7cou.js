...
window.moduloBuild.modules["xx9akh26"] = function library1_ActionNetworkForm_script (modulo) {
var script = { exports: {} }; var script, style;

        const scriptId = 'anv5embedscript';
        const linkId = 'anv5embedlink';
        function updateCallback() {
            if (modulo.config.IS_BUILD) { // don't run during build
                return;
            }
            if(!document.getElementById(scriptId)) {
...
window.moduloBuild.nameToHash.library1_ActionNetworkForm_script = "xx9akh26";
