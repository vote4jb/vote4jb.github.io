...
window.moduloBuild.modules["x1p00b1o"] = function library1_ActionNetworkForm_script (modulo) {
var script = { exports: {} }; var script, style;
        ...
        function updateCallback() {
            const cmd = new URLSearchParams(window.location.search).get('mod-cmd');
            if (cmd && cmd === 'build') { // skip during build
                return;
            }
            if(!document.getElementById(scriptId)) {
...
window.moduloBuild.nameToHash.library1_ActionNetworkForm_script = "x1p00b1o";
