...
window.moduloBuild.modules["x1kmsgas"] = function library1_ContactForm_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n<div class=\"form-container\">\n    <h2>"); // "<div class=\"form-container\"><h2>"
  OUT.push(G.escapeText(CTX.state.title)); // "state.title"
  OUT.push("</h2>\n    <form name=\"contact\" method=\"POST\" netlify>\n        "); // "</h2><form name=\"contact\" method=\"POST\" netlify>"
...
window.moduloBuild.modules["x10v0g7a"] = function library_MobileNavBar_staticdata (modulo) {
return {"navigation":[{"title":"About","file":"about/"},{"title":"Endorsements","file":"endorsements/"},{"title":"Contact","file":"contact/"}],"smallNav":[{"href":"/contact/?volunteer=y","title":"Volunteer"},{"href":"/contact/?pledge=y","title":"Pledge"}]};
};
window.moduloBuild.modules["xxo08nn4"] = function library_MobileNavBar_template (modulo) {
return function (CTX, G) { var OUT=[];
  if (CTX.props.selected === "index.html") { // "if props.selected == \"index.html\""
  OUT.push("\n    <div class=\"top-splash\">\n        <a href=\"#\">\n            <img class=\"background-splash\" src=\"/static/images/seiu_jovanka_1.jpg\">\n\n            <img class=\"right-cutout\" src=\"/static/images/hero/portrait_cut_out_cropped_2.png\">\n\n            <img\n                class=\"left-logo\"\n                src=\"/static/images/logo1_transparent_filled_shadow_alt.png\"\n                alt=\"Delivering Results Together! Jovanka Beckles for State Senate\"\n            />\n        </a>\n    </div>\n"); // "<div class=\"top-splash\"><a href=\"#\"><img class=\"background-splash\" src=\"/static/images/seiu_jovanka_1.jpg\"><img class=\"right-cutout\" src=\"/static/images/hero/portrait_cut_out_cropped_2.png\"><img class=\"left-logo\" src=\"/static/images/logo1_transparent_filled_shadow_alt.png\" alt=\"Delivering Results Together! Jovanka Beckles for State Senate\" /></a></div>"
  } else { // "else"
  OUT.push("\n    <div class=\"menu-holder\"  @click:=script.toggle>\n        <a>☰</a>\n    </div>\n\n    <nav class=\"right-logo-holder\">\n        <a href=\"/\">\n            <img\n                src=\"/static/images/logo1_transparent_filled_shadow_alt.png\"\n                class=\"right-logo\"\n                alt=\"Delivering Results Together! Jovanka Beckles for State Senate\"\n            />\n        </a>\n    </nav>\n"); // "<div class=\"menu-holder\" @click:=script.toggle><a>☰</a></div><nav class=\"right-logo-holder\"><a href=\"/\"><img src=\"/static/images/logo1_transparent_filled_shadow_alt.png\" class=\"right-logo\" alt=\"Delivering Results Together! Jovanka Beckles for State Senate\" /></a></nav>"
  } // "endif"
  ...
  OUT.push(G.escapeText(G.filters["length"](CTX.script.volunteerNav))); // "script.volunteerNav|length"
  OUT.push(", 1fr)\">\n        "); // ", 1fr)\">"
...
window.moduloBuild.modules["x16cakng"] = function library_NavBar_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n\n<a name=\"nav\"></a>\n<nav class=\"Page-nav layout-container\">\n    <div style=\"grid-column: 1;\" class=\"logo-wrapper\">\n        <a href=\"/\" style=\"border: none\">\n            "); // "<a name=\"nav\"></a><nav class=\"Page-nav layout-container\"><div style=\"grid-column: 1;\" class=\"logo-wrapper\"><a href=\"/\" style=\"border: none\">"
  if (CTX.props.selected != "index.html") { // "if props.selected != \"index.html\""
  ...
  */ // "endcomment"
  ...
  if (CTX.props.selected === "index.html") { // "if props.selected == \"index.html\""
  OUT.push("\n    <img class=\"background-splash-cover\" src=\"/static/images/seiu_jovanka_1.jpg\">\n\n    <img class=\"right-cutout\" src=\"/static/images/hero/portrait_cut_out_cropped_2.png\">\n\n    <img\n        class=\"left-logo\"\n        src=\"/static/images/logo1_transparent_filled_shadow_alt.png\"\n        alt=\"Delivering Results Together! Jovanka Beckles for State Senate\"\n    />\n"); // "<img class=\"background-splash-cover\" src=\"/static/images/seiu_jovanka_1.jpg\"><img class=\"right-cutout\" src=\"/static/images/hero/portrait_cut_out_cropped_2.png\"><img class=\"left-logo\" src=\"/static/images/logo1_transparent_filled_shadow_alt.png\" alt=\"Delivering Results Together! Jovanka Beckles for State Senate\" />"
  } // "endif"
  OUT.push("\n\n\n"); // ""
  /* // "comment"
  OUT.push("\n"); // ""
...
window.moduloBuild.modules["xxe69d90"] = function library_Page_script (modulo) {
...
return {"prepareCallback": typeof prepareCallback !== "undefined" ? prepareCallback : undefined, setLocalVariables: function(o) {staticdata=o.staticdata; element=o.element}, exports: script.exports }

};
window.moduloBuild.modules["x1ark730"] = function library_Page_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("<head>\n    <title>"); // "<head><title>"
...
window.moduloBuild.nameToHash = {
 ...
 "library_Page_template": "x1ark730",
 "library_Page_staticdata": "x10v0g7a",
 "library_NavBar_template": "x16cakng",
 "library_NavBar_staticdata": "x10v0g7a",
 "library_MobileNavBar_template": "xxo08nn4",
 "library_MobileNavBar_staticdata": "x10v0g7a",
 "library1_ContactForm_template": "x1kmsgas"
};
