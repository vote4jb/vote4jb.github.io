...
window.moduloBuild.modules["xxaiff9l"] = function library_Page_script (modulo) {
var script = { exports: {} }; var script;
        ...
        function handleScroll(scrollPos) {
            ...
            if (scrollPos > THRESH) {
                image.setAttribute('style', `width: ${ originalParentWidth }; max-width: 100%`);
                /*image.setAttribute('style', '');*/
            } else {
                const diff = originalWidth - originalParentWidth;
                image.setAttribute('style', `width: ${ originalWidth }px; max-width: ${ logoMax }; margin-right: -${diff}px`);
            }
        }
...
return {"prepareCallback": typeof prepareCallback !== "undefined" ? prepareCallback : undefined, "_getDimensions": typeof _getDimensions !== "undefined" ? _getDimensions : undefined, "imageMount": typeof imageMount !== "undefined" ? imageMount : undefined, "handleScroll": typeof handleScroll !== "undefined" ? handleScroll : undefined, setLocalVariables: function(o) {script=o.script}, exports: script.exports }

};
window.moduloBuild.modules["xxu19vdl"] = function library_Page_template (modulo) {
return function (CTX, G) { var OUT=[];
  ...
  OUT.push("\n    </ul>\n    <div class=\"right-links\" style=\"grid-column: 3\"><!--<a href=\"#\">Get Involved!</a>--></div>\n</nav>\n\n<div class=\"Page-navHBMenu\">\n    <a href=\"#nav\" class=\"btn-hbmenu\">☰</a>\n</div>\n\n<a name=\"c\"></a> <!-- c = content -->\n"); // "</ul><div class=\"right-links\" style=\"grid-column: 3\"><!--<a href=\"#\">Get Involved!</a>--></div></nav><div class=\"Page-navHBMenu\"><a href=\"#nav\" class=\"btn-hbmenu\">☰</a></div><a name=\"c\"></a><!-- c = content -->"
...
window.moduloBuild.nameToHash = {
 ...
 "library_Page_script": "xxaiff9l",
 "library_Page_template": "xxu19vdl"
};
