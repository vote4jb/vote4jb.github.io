...
window.moduloBuild.modules["x142ckq0"] = function configuration (modulo) {

    window.dataLayer = window.dataLayer || [];
    function gtag() { window.dataLayer.push(arguments); }

    // XXX
    // VERY FRAGILE way to skip during automated build
...
window.moduloBuild.nameToHash.configuration = "x142ckq0";
...
window.moduloBuild.modules["x1rs32fe"] = function library1_ActionNetworkForm_script (modulo) {
...
window.moduloBuild.nameToHash.library1_ActionNetworkForm_script = "x1rs32fe";
