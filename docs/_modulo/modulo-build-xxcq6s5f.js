...
window.moduloBuild.modules["x1t595m2"] = function library1_ContactForm_template (modulo) {
return function (CTX, G) { var OUT=[];
  ...
  OUT.push("\">\n                            <li style=\"display:none\"> <!-- Hack to add a label to email / CSV -->\n                                <label>\n                                    PLEDGE\n                                    <input type=\"checkbox\" name=\"my-sheep\" value=\"\">\n                                </label>\n                            </li>\n                            "); // "\"><li style=\"display:none\"><!-- Hack to add a label to email / CSV --><label> PLEDGE <input type=\"checkbox\" name=\"my-sheep\" value=\"\"></label></li>"
...
window.moduloBuild.nameToHash = {
 ...
 "library1_ContactForm_template": "x1t595m2"
};
