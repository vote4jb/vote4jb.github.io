...
window.moduloBuild.modules["xxfqhdgd"] = function library_Page_script (modulo) {
...
window.moduloBuild.modules["x1tj6jq4"] = function library_Page_template (modulo) {
return function (CTX, G) { var OUT=[];
  ...
  OUT.push("\n    </ul>\n    "); // "</ul>"
  if (CTX.props.navselected != "index.html") { // "if props.navselected != \"index.html\""
  OUT.push("\n    <div style=\"grid-column: 3\">\n        <a href=\"/contact/\" class=\"join-the-cause-nav-button\">Join the cause!</a>\n    </div>\n    "); // "<div style=\"grid-column: 3\"><a href=\"/contact/\" class=\"join-the-cause-nav-button\">Join the cause!</a></div>"
  } // "endif"
  OUT.push("\n\n    "); // ""
  /* // "comment"
  OUT.push("\n    <div class=\"right-involvement-nav\" style=\"grid-column: 3\">\n        <div class=\"right-topbutton-holder\">\n            "); // "<div class=\"right-involvement-nav\" style=\"grid-column: 3\"><div class=\"right-topbutton-holder\">"
  OUT.push("\n            <a href=\"/contact/\" class=\"join-the-cause-nav-button\">Join the cause!</a>\n        </div>\n        "); // "<a href=\"/contact/\" class=\"join-the-cause-nav-button\">Join the cause!</a></div>"
  if (CTX.props.navselected === "index.html") { // "if props.navselected == \"index.html\""
  ...
  */ // "endcomment"
  ...
  OUT.push("\n\n"); // ""
  if (CTX.props.navselected === "index.html") { // "if props.navselected == \"index.html\""
  OUT.push("\n<div style=\"position: absolute; right: 20px; top: 350px; z-index: 10; height: 100%; max-height: 100%\">\n    <div style=\"position: sticky; top: 2px\">\n        <a class=\"hero-cta\" href=\"/contact/\">\n            Join the cause\n            <!--<span style=\"font-weight: 200\" alt=\"Right arrow\">&#x29d0;</span>-->\n            <span style=\"font-weight: 200\" alt=\"Right arrow\">&#x25B9;</span>\n        </a>\n    </div>\n</div>\n"); // "<div style=\"position: absolute; right: 20px; top: 350px; z-index: 10; height: 100%; max-height: 100%\"><div style=\"position: sticky; top: 2px\"><a class=\"hero-cta\" href=\"/contact/\"> Join the cause <!--<span style=\"font-weight: 200\" alt=\"Right arrow\">&#x29d0;</span>--><span style=\"font-weight: 200\" alt=\"Right arrow\">&#x25B9;</span></a></div></div>"
  } // "endif"
...
window.moduloBuild.nameToHash = {
 ...
 "library_Page_script": "xxfqhdgd",
 "library_Page_template": "x1tj6jq4"
};
