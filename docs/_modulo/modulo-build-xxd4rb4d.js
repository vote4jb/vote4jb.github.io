...
window.moduloBuild.modules["xxcvnq58"] = function library1_ActionNetworkForm_script (modulo) {
var script = { exports: {} }; var script, style;
        ...
        function updateCallback() {
            // XXX
            // VERY FRAGILE way to skip during automated build
            const port = String(location.host);
            console.log('this is port', port);
            if (port === '6627') { // skip during build
                return;
            }
            if(!document.getElementById(scriptId)) {
...
window.moduloBuild.nameToHash.library1_ActionNetworkForm_script = "xxcvnq58";
