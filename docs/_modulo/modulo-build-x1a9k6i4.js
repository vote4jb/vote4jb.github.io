...
window.moduloBuild.modules["xx7dl3th"] = function library_NavBar_script (modulo) {
...
window.moduloBuild.nameToHash.library_NavBar_script = "xx7dl3th";

window.moduloBuild.modules["xx7dl3th"] = function library_MobileNavBar_script (modulo) {
var script = { exports: {} }; var props, state, script, element;
const volunteerNav = [
        {
            href: '/contact/?volunteer=y',
...
window.moduloBuild.nameToHash.library_MobileNavBar_script = "xx7dl3th";
...
window.moduloBuild.modules["xx6hg2t9"] = function library_Page_template_footer (modulo) {
...
window.moduloBuild.nameToHash.library_Page_template_footer = "xx6hg2t9";

window.moduloBuild.modules["xx8imdvk"] = function library_Page_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("<head>\n    <title>"); // "<head><title>"
...
window.moduloBuild.nameToHash.library_Page_template = "xx8imdvk";

window.moduloBuild.modules["xx7l93j7"] = function library_Page_staticdata (modulo) {
return {"navigation":[{"title":"About","file":"about/"},{"title":"Platform","file":"platform/"},{"title":"Endorsements","file":"endorsements/"},{"title":"News","file":"news/"}],"linkNav":[{"href":"/find-my-district/","title":"Find my district..."},{"href":"/contact/endorse.html","title":"Endorse Jovanka"}],"smallNav":[{"href":"/contact/volunteer.html","title":"Volunteer"},{"href":"/contact/donate.html","title":"Donate"}]};
};
window.moduloBuild.nameToHash.library_Page_staticdata = "xx7l93j7";

window.moduloBuild.modules["x1vb8prq"] = function library_NavBar_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("<nav class=\"Page-nav layout-container\" style=\""); // "<nav class=\"Page-nav layout-container\" style=\""
...
window.moduloBuild.nameToHash.library_NavBar_template = "x1vb8prq";

window.moduloBuild.modules["xx7l93j7"] = function library_NavBar_staticdata (modulo) {
return {"navigation":[{"title":"About","file":"about/"},{"title":"Platform","file":"platform/"},{"title":"Endorsements","file":"endorsements/"},{"title":"News","file":"news/"}],"linkNav":[{"href":"/find-my-district/","title":"Find my district..."},{"href":"/contact/endorse.html","title":"Endorse Jovanka"}],"smallNav":[{"href":"/contact/volunteer.html","title":"Volunteer"},{"href":"/contact/donate.html","title":"Donate"}]};
};
window.moduloBuild.nameToHash.library_NavBar_staticdata = "xx7l93j7";

window.moduloBuild.modules["xxm1qktj"] = function library_EndorsementsGallery_template (modulo) {
return function (CTX, G) { var OUT=[];
  if (CTX.props.button) { // "if props.button"
  OUT.push("\n    <h2 style=\"margin: 3vw 0 0 3vw\";>\n        Endorsed by trusted East Bay elected officials and community leaders\n    </h2>\n    <!--\n    <h3>\n        Including 10+ East Bay\n        Mayors & Councilmembers:\n    </h2>\n    -->\n"); // "<h2 style=\"margin: 3vw 0 0 3vw\";> Endorsed by trusted East Bay elected officials and community leaders </h2><!-- <h3> Including 10+ East Bay Mayors & Councilmembers: </h2> -->"
  } // "endif"
  ...
  if (CTX.props.button) { // "if props.button"
  OUT.push("\n        <img\n            src=\"/static/images/endorsements/2305/pinole_pa_instagram.jpg\" \n        />\n        <a class=\"j4s-Btn\" href=\"/endorsements/\">See the rest <br /> &#8640;</a>\n    "); // "<img src=\"/static/images/endorsements/2305/pinole_pa_instagram.jpg\" /><a class=\"j4s-Btn\" href=\"/endorsements/\">See the rest <br /> &#8640;</a>"
  } // "endif"
  OUT.push("\n</div>\n"); // "</div>"

return OUT.join(""); };
};
window.moduloBuild.nameToHash.library_EndorsementsGallery_template = "xxm1qktj";

window.moduloBuild.modules["x1ce5j76"] = function library_MobileNavBar_template (modulo) {
return function (CTX, G) { var OUT=[];
  if (CTX.props.selected === "index.html") { // "if props.selected == \"index.html\""
...
window.moduloBuild.nameToHash.library_MobileNavBar_template = "x1ce5j76";

window.moduloBuild.modules["xx7l93j7"] = function library_MobileNavBar_staticdata (modulo) {
return {"navigation":[{"title":"About","file":"about/"},{"title":"Platform","file":"platform/"},{"title":"Endorsements","file":"endorsements/"},{"title":"News","file":"news/"}],"linkNav":[{"href":"/find-my-district/","title":"Find my district..."},{"href":"/contact/endorse.html","title":"Endorse Jovanka"}],"smallNav":[{"href":"/contact/volunteer.html","title":"Volunteer"},{"href":"/contact/donate.html","title":"Donate"}]};
};
window.moduloBuild.nameToHash.library_MobileNavBar_staticdata = "xx7l93j7";
...
window.moduloBuild.modules["x185pkos"] = function library_HeroInset_template (modulo) {
return function (CTX, G) { var OUT=[];
...
library_Page_template_footer: {"Parent":"library_Page","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"Name":"template_footer","DefinitionName":"library_Page_template_footer","Source":"http://127.0.0.1:6627/static/libraries/layout/Page-footer.html","Hash":"Txx6hg2t9"}, 

library_Page_template: {"Parent":"library_Page","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"library_Page_template","Source":"http://127.0.0.1:6627/static/libraries/layout/Page.html","Hash":"Txx8imdvk"}, 
...
library_NavBar_template: {"Parent":"library_NavBar","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"library_NavBar_template","Source":"http://127.0.0.1:6627/static/libraries/layout/NavBar.html","Hash":"Tx1vb8prq"}, 
...
library_EndorsementsGallery_template: {"Parent":"library_EndorsementsGallery","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"library_EndorsementsGallery_template","Source":"http://127.0.0.1:6627/static/libraries/layout/EndorsementsGallery.html","Hash":"Txxm1qktj"}, 
...
library_MobileNavBar_template: {"Parent":"library_MobileNavBar","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"library_MobileNavBar_template","Source":"http://127.0.0.1:6627/static/libraries/layout/MobileNavBar.html","Hash":"Tx1ce5j76"}, 
...
library_HeroInset_template: {"Parent":"library_HeroInset","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"library_HeroInset_template","Source":"http://127.0.0.1:6627/static/libraries/layout/HeroInset.html","Hash":"Tx185pkos"}, 
...
library_AllBanners_template: {"Parent":"library_AllBanners","DefName":null,"Type":"Template","DefFinalizers":["TemplatePrebuild"],"Name":"template","DefinitionName":"library_AllBanners_template","Source":"http://127.0.0.1:6627/static/libraries/layout/AllBanners.html","Hash":"Tx1ih5efr"}, 
