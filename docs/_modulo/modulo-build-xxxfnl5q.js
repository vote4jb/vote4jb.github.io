...
window.moduloBuild.modules["x15548q8"] = function library1_ContactForm_script (modulo) {
...
window.moduloBuild.modules["x1miovkd"] = function library1_ContactForm_template (modulo) {
return function (CTX, G) { var OUT=[];
  ...
  OUT.push("\">\n                            <li style=\"display:none\"> <!-- Hack to add a label to email / CSV -->\n                                <label>\n                                    Pledge Value Entered (If Any):\n                                    <input type=\"checkbox\" name=\""); // "\"><li style=\"display:none\"><!-- Hack to add a label to email / CSV --><label> Pledge Value Entered (If Any): <input type=\"checkbox\" name=\""
  OUT.push(G.escapeText(CTX.field.name)); // "field.name"
  ...
  OUT.push("_"); // "_"
  OUT.push(G.escapeText(CTX.component.id)); // "component.id"
  OUT.push("_other\">\n                                    PLEDGE $_\n                                    <input\n                                        [state.bind]\n                                        name=\""); // "_other\"> PLEDGE $_ <input [state.bind] name=\""
  OUT.push(G.escapeText(CTX.field.name)); // "field.name"
...
window.moduloBuild.nameToHash = {
 ...
 "library1_ContactForm_script": "x15548q8",
 ...
 "library1_ContactForm_template": "x1miovkd"
};
