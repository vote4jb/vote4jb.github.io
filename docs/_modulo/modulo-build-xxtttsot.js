...
window.moduloBuild.modules["xx5bqfdj"] = function library1_ContactForm_script (modulo) {
var script = { exports: {} }; var state, style;
...
return {"prepareCallback": typeof prepareCallback !== "undefined" ? prepareCallback : undefined, "updateCallback": typeof updateCallback !== "undefined" ? updateCallback : undefined, setLocalVariables: function(o) {state=o.state; style=o.style}, exports: script.exports }

};
window.moduloBuild.modules["xxkmce89"] = function library1_ContactForm_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n<div class=\"form-container\">\n    <h2>"); // "<div class=\"form-container\"><h2>"
  OUT.push(G.escapeText(CTX.state.title)); // "state.title"
  OUT.push("</h2>\n    <form name=\""); // "</h2><form name=\""
  OUT.push(G.escapeText(CTX.script.form_name)); // "script.form_name"
  OUT.push("\" method=\"POST\" netlify>\n        "); // "\" method=\"POST\" netlify>"
  var ARR0=CTX.script.fields;for (var KEY in ARR0) {CTX. field=ARR0[KEY]; // "for field in script.fields"
  OUT.push("\n            "); // ""
  if (("volunteer,pledge").includes ? ("volunteer,pledge").includes(CTX.field.name) : (CTX.field.name in "volunteer,pledge")) { // "if field.name in \"volunteer,pledge\""
  ...
  OUT.push("\n                        </label>\n                        "); // "</label>"
  if (CTX.field.name === "pledge") { // "if field.name == \"pledge\""
  OUT.push("\n                            <ul class=\"submenu "); // "<ul class=\"submenu"
  if (CTX.state.pledge) { // "if state.pledge"
...
window.moduloBuild.modules["xxsuvu7u"] = function library_NavBar_script (modulo) {
var script = { exports: {} }; var props, script, element;
function prepareCallback() {
...
return {"prepareCallback": typeof prepareCallback !== "undefined" ? prepareCallback : undefined, "_getDimensions": typeof _getDimensions !== "undefined" ? _getDimensions : undefined, "imageMount": typeof imageMount !== "undefined" ? imageMount : undefined, "handleScroll": typeof handleScroll !== "undefined" ? handleScroll : undefined, setLocalVariables: function(o) {props=o.props; script=o.script; element=o.element}, exports: script.exports }

};
window.moduloBuild.modules["xxgiq1rd"] = function library_NavBar_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n\n<a name=\"nav\"></a>\n<nav class=\"Page-nav layout-container\">\n    <div style=\"grid-column: 1;\" class=\"logo-wrapper\">\n        <a href=\"/\" style=\"border: none\">\n            <img\n                [script.image]\n                class=\"\n                    nav-logo\n                    "); // "<a name=\"nav\"></a><nav class=\"Page-nav layout-container\"><div style=\"grid-column: 1;\" class=\"logo-wrapper\"><a href=\"/\" style=\"border: none\"><img [script.image] class=\" nav-logo"
  if (CTX.props.selected === "index.html") { // "if props.selected == \"index.html\""
  OUT.push("\n                        nav-logo--hero\n                    "); // "nav-logo--hero"
  } // "endif"
  OUT.push("\n                \"\n                src=\"/static/images/logo1_transparent_filled_shadow_alt.png\" alt=\"Delivering Results! Together. Jovanka Beckles for State Senate\"\n            />\n            "); // "\" src=\"/static/images/logo1_transparent_filled_shadow_alt.png\" alt=\"Delivering Results! Together. Jovanka Beckles for State Senate\" />"
  /* // "comment"
  OUT.push("\n            "); // ""
  OUT.push("\n            "); // ""
  if (CTX.props.selected === "index.html") { // "if props.selected == \"index.html\""
  OUT.push("\n                <img\n                    [script.image]\n                    style=\"width: "); // "<img [script.image] style=\"width:"
  OUT.push(G.escapeText(CTX.script.exports.logoSize)); // "script.exports.logoSize"
  OUT.push("00%; max-width: "); // "00%; max-width:"
  OUT.push(G.escapeText(CTX.script.exports.logoMax)); // "script.exports.logoMax"
  OUT.push("; transition: 0.3s !important;\"\n                    src=\"/static/images/logo1_transparent_filled_shadow_alt.png\" alt=\"Delivering Results! Together. Jovanka Beckles for State Senate\"\n                />\n            "); // "; transition: 0.3s !important;\" src=\"/static/images/logo1_transparent_filled_shadow_alt.png\" alt=\"Delivering Results! Together. Jovanka Beckles for State Senate\" />"
  } else { // "else"
  OUT.push("\n                <img\n                    src=\"/static/images/logo1_transparent_filled_shadow_alt.png\" alt=\"Delivering Results! Together. Jovanka Beckles for State Senate\"\n                />\n            "); // "<img src=\"/static/images/logo1_transparent_filled_shadow_alt.png\" alt=\"Delivering Results! Together. Jovanka Beckles for State Senate\" />"
  } // "endif"
  OUT.push("\n            "); // ""
  */ // "endcomment"
  OUT.push("\n        </a>\n    </div>\n    <ul>\n        "); // "</a></div><ul>"
  ...
  OUT.push("\n    </ul>\n\n    <div style=\"grid-column: 3; width: 250px\">\n        <a href=\"/contact/?volunteer=y\" class=\"right-cta\">Volunteer</a>\n        <a href=\"/contact/?pledge=y\" class=\"right-cta\">Pledge</a>\n    </div>\n\n"); // "</ul><div style=\"grid-column: 3; width: 250px\"><a href=\"/contact/?volunteer=y\" class=\"right-cta\">Volunteer</a><a href=\"/contact/?pledge=y\" class=\"right-cta\">Pledge</a></div>"
  /* // "comment"
  OUT.push("\n    "); // ""
  if (CTX.props.selected != "index.html") { // "if props.selected != \"index.html\""
  OUT.push("\n    "); // ""
  } // "endif"
  OUT.push("\n    <div class=\"right-involvement-nav\" style=\"grid-column: 3\">\n        <div class=\"right-topbutton-holder\">\n            <a href=\"/contact/\" class=\"join-the-cause-nav-button\">Join the cause!</a>\n        </div>\n        "); // "<div class=\"right-involvement-nav\" style=\"grid-column: 3\"><div class=\"right-topbutton-holder\"><a href=\"/contact/\" class=\"join-the-cause-nav-button\">Join the cause!</a></div>"
  if (CTX.props.selected === "index.html") { // "if props.selected == \"index.html\""
  OUT.push("\n        <div class=\"right-dropdown-holder\">\n            <h1 class=\"join-the-cause-title-button\"><a href=\"#c\">Join the cause!</a></h1>\n            <h2>Volunteer</h2>\n\n\n<form action=\"https://tinyletter.com/freecodinglessons\" method=\"post\" target=\"popupwindow\" onsubmit=\"window.open('https://tinyletter.com/freecodinglessons', 'popupwindow', 'scrollbars=yes,width=800,height=600');return true\">\n<input type=\"hidden\" value=\"1\" name=\"embed\"/>\n<input type=\"text\" name=\"email\" id=\"tlemail\" placeholder=\"Enter your e-mail...\" />\n<button>Sign-up to be notified</button>\n</form>\n            <p>Just an hour of time can make a difference. <em>Newbies\n            welcome!</em></p>\n\n            <h2>Donate</h2>\n            <a href=\"#\">Donate $2</a>\n            <a href=\"#\">Donate $9</a>\n            <a href=\"#\">Donate $27</a>\n            <a href=\"#\">Donate $50</a>\n            <a href=\"#\">Donate $200</a>\n            <p>If we all chip in, we can go toe-to-toe against corporate-funded\n            campaigns that oppose our bold, progressive grass-roots movement.</p>\n        </div>\n    </div>\n        "); // "<div class=\"right-dropdown-holder\"><h1 class=\"join-the-cause-title-button\"><a href=\"#c\">Join the cause!</a></h1><h2>Volunteer</h2><form action=\"https://tinyletter.com/freecodinglessons\" method=\"post\" target=\"popupwindow\" onsubmit=\"window.open('https://tinyletter.com/freecodinglessons', 'popupwindow', 'scrollbars=yes,width=800,height=600');return true\"><input type=\"hidden\" value=\"1\" name=\"embed\"/><input type=\"text\" name=\"email\" id=\"tlemail\" placeholder=\"Enter your e-mail...\" /><button>Sign-up to be notified</button></form><p>Just an hour of time can make a difference. <em>Newbies welcome!</em></p><h2>Donate</h2><a href=\"#\">Donate $2</a><a href=\"#\">Donate $9</a><a href=\"#\">Donate $27</a><a href=\"#\">Donate $50</a><a href=\"#\">Donate $200</a><p>If we all chip in, we can go toe-to-toe against corporate-funded campaigns that oppose our bold, progressive grass-roots movement.</p></div></div>"
  } // "endif"
  OUT.push("\n    "); // ""
  */ // "endcomment"
  OUT.push("\n    <!--<div class=\"right-links\" style=\"grid-column: 3\"></div>-->\n</nav>\n\n<div class=\"Page-navHBMenu\">\n    <a href=\"#nav\" class=\"btn-hbmenu\">☰</a>\n</div>\n\n<a name=\"c\"></a> <!-- c = content -->\n\n\n"); // "<!--<div class=\"right-links\" style=\"grid-column: 3\"></div>--></nav><div class=\"Page-navHBMenu\"><a href=\"#nav\" class=\"btn-hbmenu\">☰</a></div><a name=\"c\"></a><!-- c = content -->"
  /* // "comment"
  OUT.push("\n"); // ""
  if (CTX.props.selected === "index.html") { // "if props.selected == \"index.html\""
  OUT.push("\n<div style=\"position: absolute; right: 20px; top: 350px; z-index: 10; height: 100%; max-height: 100%\">\n    <div style=\"position: sticky; top: 2px\">\n        <a class=\"hero-cta\" href=\"/contact/\">\n            Volunteer\n            <!--<span style=\"font-weight: 200\" alt=\"Right arrow\">&#x29d0;</span>-->\n            <span style=\"font-weight: 200\" alt=\"Right arrow\">&#x25B9;</span>\n        </a>\n        <a href=\"/contact/?volunteer=y\" class=\"join-the-cause-nav-button\">Volunteer</a>\n        <a href=\"/contact/?donate=y\" class=\"join-the-cause-nav-button\">Pledge</a>\n    </div>\n</div>\n"); // "<div style=\"position: absolute; right: 20px; top: 350px; z-index: 10; height: 100%; max-height: 100%\"><div style=\"position: sticky; top: 2px\"><a class=\"hero-cta\" href=\"/contact/\"> Volunteer <!--<span style=\"font-weight: 200\" alt=\"Right arrow\">&#x29d0;</span>--><span style=\"font-weight: 200\" alt=\"Right arrow\">&#x25B9;</span></a><a href=\"/contact/?volunteer=y\" class=\"join-the-cause-nav-button\">Volunteer</a><a href=\"/contact/?donate=y\" class=\"join-the-cause-nav-button\">Pledge</a></div></div>"
  } // "endif"
  OUT.push("\n"); // ""
  */ // "endcomment"
  OUT.push("\n\n"); // ""
...
window.moduloBuild.modules["xxkh8t0k"] = function library_Page_script (modulo) {
...
return {"prepareCallback": typeof prepareCallback !== "undefined" ? prepareCallback : undefined, setLocalVariables: function(o) {element=o.element}, exports: script.exports }

};
window.moduloBuild.modules["x1fmpn0v"] = function library_Page_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("<head>\n    <title>"); // "<head><title>"
  ...
  OUT.push("\n\n<slot class=\"Page-container layout-container\">\n</slot>\n\n<footer class=\"Page-footer layout-container\">\n    "); // "<slot class=\"Page-container layout-container\"></slot><footer class=\"Page-footer layout-container\">"
  OUT.push(CTX.template_footer.render(CTX)); // "include template_footer"
  OUT.push("\n</footer>\n</body>\n"); // "</footer></body>"

return OUT.join(""); };
};
window.moduloBuild.modules["x1s1gi0e"] = function library_Page_template_footer (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("<div class=\"u--layout\">\n    <ul>\n        <h3>Contact</h3>\n        <li><a href=\"mailto:jovanka4senate@gmail.com\">jovanka4senate@gmail.com</a></li>\n        <li><tt>1234 Street Address</tt></li>\n        <li><tt>City, CA 00000</tt></li>\n    </ul>\n\n    <ul>\n        <h3>Links</h3>\n        "); // "<div class=\"u--layout\"><ul><h3>Contact</h3><li><a href=\"mailto:jovanka4senate@gmail.com\">jovanka4senate@gmail.com</a></li><li><tt>1234 Street Address</tt></li><li><tt>City, CA 00000</tt></li></ul><ul><h3>Links</h3>"
  var ARR0=CTX.script.navigation;for (var KEY in ARR0) {CTX. page=ARR0[KEY]; // "for page in script.navigation"
  OUT.push("\n            <li>\n                <a href=\"/"); // "<li><a href=\"/"
  OUT.push(G.escapeText(CTX.page.file)); // "page.file"
  OUT.push("\"> "); // "\">"
...
window.moduloBuild.nameToHash = {
 ...
 "library_Page_script": "xxkh8t0k",
 "library_NavBar_script": "xxsuvu7u",
 "library1_ContactForm": "x11jc8t5",
 "library1_ContactForm_script": "xx5bqfdj",
 "library_Page_template_footer": "x1s1gi0e",
 "library_Page_template": "x1fmpn0v",
 "library_NavBar_template": "xxgiq1rd",
 "library1_ContactForm_template": "xxkmce89"
};
